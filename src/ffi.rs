...
pub const FLITE_PROJECT_NAME: &'static [u8; 14usize] = b"Festival Lite\0";
pub const FLITE_PROJECT_PREFIX: &'static [u8; 6usize] = b"flite\0";
pub const FLITE_PROJECT_VERSION: &'static [u8; 4usize] = b"2.2\0";
pub const FLITE_PROJECT_DATE: &'static [u8; 9usize] = b"Sep 2018\0";
pub const FLITE_PROJECT_STATE: &'static [u8; 8usize] = b"current\0";
pub const FLITE_PROJECT_SHLIB_VERSION: &'static [u8; 2usize] = b"1\0";
...
pub const CST_CG_MODEL_SHAPE_BASE_MINRANGE: u32 = 1;
pub const CST_CG_MODEL_SHAPE_QUANTIZED_PARAMS: u32 = 2;
pub const CST_CG_MODEL_SHAPE_QUANTIZED_PARAMS_41: u32 = 3;
...
extern "C" {
    pub fn cst_cstr2wstr(s: *const ::std::os::raw::c_char) -> *mut wchar_t;
}
extern "C" {
    pub fn cst_wstr2cstr(s: *const wchar_t) -> *mut ::std::os::raw::c_char;
}
...
extern "C" {
    pub fn lpc_resynth(lpcres: *mut cst_lpcres) -> *mut cst_wave;
}
extern "C" {
    pub fn lpc_resynth_fixedpoint(lpcres: *mut cst_lpcres) -> *mut cst_wave;
}
extern "C" {
    pub fn lpc_resynth_spike(lpcres: *mut cst_lpcres) -> *mut cst_wave;
}
extern "C" {
    pub fn add_residual_windowed(
...
extern "C" {
    pub fn add_residual_g721(
        targ_size: ::std::os::raw::c_int,
        targ_residual: *mut ::std::os::raw::c_uchar,
        packed_unit_size: ::std::os::raw::c_int,
        unit_residual: *const ::std::os::raw::c_uchar,
    );
}
extern "C" {
    pub fn add_residual_g721vuv(
        targ_size: ::std::os::raw::c_int,
        targ_residual: *mut ::std::os::raw::c_uchar,
        uunit_size: ::std::os::raw::c_int,
        unit_residual: *const ::std::os::raw::c_uchar,
    );
}
extern "C" {
    pub fn add_residual_vuv(
        targ_size: ::std::os::raw::c_int,
        targ_residual: *mut ::std::os::raw::c_uchar,
        packed_unit_size: ::std::os::raw::c_int,
        unit_residual: *const ::std::os::raw::c_uchar,
...
#[repr(C)]
#[derive(Debug, Copy, Clone)]
pub struct cst_lts_rewrites_struct {
    pub name: *mut ::std::os::raw::c_char,
    pub sets: *const cst_val,
    pub rules: *const cst_val,
}
#[test]
fn bindgen_test_layout_cst_lts_rewrites_struct() {
    assert_eq!(
        ::std::mem::size_of::<cst_lts_rewrites_struct>(),
        24usize,
        concat!("Size of: ", stringify!(cst_lts_rewrites_struct))
    );
    assert_eq!(
        ::std::mem::align_of::<cst_lts_rewrites_struct>(),
        8usize,
        concat!("Alignment of ", stringify!(cst_lts_rewrites_struct))
    );
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<cst_lts_rewrites_struct>())).name as *const _ as usize },
        0usize,
        concat!(
            "Offset of field: ",
            stringify!(cst_lts_rewrites_struct),
            "::",
            stringify!(name)
        )
    );
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<cst_lts_rewrites_struct>())).sets as *const _ as usize },
        8usize,
        concat!(
            "Offset of field: ",
            stringify!(cst_lts_rewrites_struct),
    ...
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<cst_lts_rewrites_struct>())).rules as *const _ as usize },
        16usize,
        concat!(
            "Offset of field: ",
            stringify!(cst_lts_rewrites_struct),
...
pub type cst_lts_rewrites = cst_lts_rewrites_struct;
extern "C" {
    pub fn lts_rewrites(itape: *const cst_val, r: *const cst_lts_rewrites) -> *mut cst_val;
}
extern "C" {
    pub fn lts_rewrites_word(
        word: *const ::std::os::raw::c_char,
        r: *const cst_lts_rewrites,
    ) -> *mut cst_val;
}
extern "C" {
    pub fn cst_args(
        ...
        args: *mut cst_features,
    ) -> *mut cst_val;
}
#[repr(C)]
#[derive(Debug, Copy, Clone)]
pub struct cst_cg_db_struct {
    pub name: *const ::std::os::raw::c_char,
    pub types: *const *const ::std::os::raw::c_char,
    pub num_types: ::std::os::raw::c_int,
    pub sample_rate: ::std::os::raw::c_int,
    pub f0_mean: f32,
    pub f0_stddev: f32,
    pub num_f0_models: ::std::os::raw::c_int,
    pub f0_trees: *mut *mut *const cst_cart,
    pub num_param_models: ::std::os::raw::c_int,
    pub param_trees: *mut *mut *const cst_cart,
    pub spamf0_accent_tree: *const cst_cart,
    pub spamf0_phrase_tree: *const cst_cart,
    pub num_channels: *mut ::std::os::raw::c_int,
    pub num_frames: *mut ::std::os::raw::c_int,
    pub model_vectors: *mut *mut *const ::std::os::raw::c_ushort,
    pub num_channels_spamf0_accent: ::std::os::raw::c_int,
    pub num_frames_spamf0_accent: ::std::os::raw::c_int,
    pub spamf0_accent_vectors: *const *const f32,
    pub model_min: *const f32,
    pub model_range: *const f32,
    pub qtable: *mut *mut *const f32,
    pub model_shape: ::std::os::raw::c_int,
    pub frame_advance: f32,
    pub num_dur_models: ::std::os::raw::c_int,
    pub dur_stats: *mut *mut *const dur_stat,
    pub dur_cart: *mut *const cst_cart,
    pub phone_states: *const *const *const ::std::os::raw::c_char,
    pub do_mlpg: ::std::os::raw::c_int,
    pub dynwin: *mut f32,
    pub dynwinsize: ::std::os::raw::c_int,
    pub mlsa_alpha: f32,
    pub mlsa_beta: f32,
    pub multimodel: ::std::os::raw::c_int,
    pub mixed_excitation: ::std::os::raw::c_int,
    pub ME_num: ::std::os::raw::c_int,
    pub ME_order: ::std::os::raw::c_int,
    pub me_h: *const *const f64,
    pub spamf0: ::std::os::raw::c_int,
    pub gain: f32,
    pub phoneset: *const cst_phoneset,
    pub char_sym_map: *const *const ::std::os::raw::c_char,
    pub sym_phone_map: *const *const ::std::os::raw::c_char,
    pub freeable: ::std::os::raw::c_int,
}
#[test]
fn bindgen_test_layout_cst_cg_db_struct() {
    assert_eq!(
        ::std::mem::size_of::<cst_cg_db_struct>(),
        280usize,
        concat!("Size of: ", stringify!(cst_cg_db_struct))
    );
    assert_eq!(
        ::std::mem::align_of::<cst_cg_db_struct>(),
        8usize,
        concat!("Alignment of ", stringify!(cst_cg_db_struct))
    );
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<cst_cg_db_struct>())).name as *const _ as usize },
        0usize,
        concat!(
            "Offset of field: ",
            stringify!(cst_cg_db_struct),
            "::",
            stringify!(name)
        )
    );
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<cst_cg_db_struct>())).types as *const _ as usize },
        8usize,
        concat!(
            "Offset of field: ",
            stringify!(cst_cg_db_struct),
    ...
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<cst_cg_db_struct>())).num_types as *const _ as usize },
        16usize,
        concat!(
            "Offset of field: ",
            stringify!(cst_cg_db_struct),
    ...
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<cst_cg_db_struct>())).sample_rate as *const _ as usize },
        20usize,
        concat!(
            "Offset of field: ",
            stringify!(cst_cg_db_struct),
    ...
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<cst_cg_db_struct>())).f0_mean as *const _ as usize },
        24usize,
        concat!(
            "Offset of field: ",
            stringify!(cst_cg_db_struct),
    ...
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<cst_cg_db_struct>())).f0_stddev as *const _ as usize },
        28usize,
        concat!(
            "Offset of field: ",
            stringify!(cst_cg_db_struct),
    ...
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<cst_cg_db_struct>())).num_f0_models as *const _ as usize },
        32usize,
        concat!(
            "Offset of field: ",
            stringify!(cst_cg_db_struct),
            "::",
            stringify!(num_f0_models)
        )
    );
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<cst_cg_db_struct>())).f0_trees as *const _ as usize },
        40usize,
        concat!(
            "Offset of field: ",
            stringify!(cst_cg_db_struct),
    ...
    assert_eq!(
        unsafe {
            &(*(::std::ptr::null::<cst_cg_db_struct>())).num_param_models as *const _ as usize
        },
        48usize,
        concat!(
            "Offset of field: ",
            stringify!(cst_cg_db_struct),
            "::",
            stringify!(num_param_models)
        )
    );
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<cst_cg_db_struct>())).param_trees as *const _ as usize },
        56usize,
        concat!(
            "Offset of field: ",
            stringify!(cst_cg_db_struct),
            "::",
            stringify!(param_trees)
        )
    );
    assert_eq!(
        unsafe {
            &(*(::std::ptr::null::<cst_cg_db_struct>())).spamf0_accent_tree as *const _ as usize
        },
        64usize,
        concat!(
            "Offset of field: ",
            stringify!(cst_cg_db_struct),
            "::",
            stringify!(spamf0_accent_tree)
        )
    );
    assert_eq!(
        unsafe {
            &(*(::std::ptr::null::<cst_cg_db_struct>())).spamf0_phrase_tree as *const _ as usize
        },
        72usize,
        concat!(
            "Offset of field: ",
            stringify!(cst_cg_db_struct),
            "::",
            stringify!(spamf0_phrase_tree)
        )
    );
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<cst_cg_db_struct>())).num_channels as *const _ as usize },
        80usize,
        concat!(
            "Offset of field: ",
            stringify!(cst_cg_db_struct),
    ...
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<cst_cg_db_struct>())).num_frames as *const _ as usize },
        88usize,
        concat!(
            "Offset of field: ",
            stringify!(cst_cg_db_struct),
    ...
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<cst_cg_db_struct>())).model_vectors as *const _ as usize },
        96usize,
        concat!(
            "Offset of field: ",
            stringify!(cst_cg_db_struct),
            "::",
            stringify!(model_vectors)
        )
    );
    assert_eq!(
        unsafe {
            &(*(::std::ptr::null::<cst_cg_db_struct>())).num_channels_spamf0_accent as *const _
                as usize
        },
        104usize,
        concat!(
            ...
            stringify!(cst_cg_db_struct),
            "::",
            stringify!(num_channels_spamf0_accent)
        )
    );
    assert_eq!(
        unsafe {
            &(*(::std::ptr::null::<cst_cg_db_struct>())).num_frames_spamf0_accent as *const _
                as usize
        },
        108usize,
        concat!(
            ...
            stringify!(cst_cg_db_struct),
            "::",
            stringify!(num_frames_spamf0_accent)
        )
    );
    assert_eq!(
        unsafe {
            &(*(::std::ptr::null::<cst_cg_db_struct>())).spamf0_accent_vectors as *const _ as usize
        },
        112usize,
        concat!(
            "Offset of field: ",
            stringify!(cst_cg_db_struct),
            "::",
            stringify!(spamf0_accent_vectors)
        )
    );
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<cst_cg_db_struct>())).model_min as *const _ as usize },
        120usize,
        concat!(
            "Offset of field: ",
            stringify!(cst_cg_db_struct),
    ...
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<cst_cg_db_struct>())).model_range as *const _ as usize },
        128usize,
        concat!(
            "Offset of field: ",
            stringify!(cst_cg_db_struct),
            "::",
            stringify!(model_range)
        )
    );
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<cst_cg_db_struct>())).qtable as *const _ as usize },
        136usize,
        concat!(
            "Offset of field: ",
            stringify!(cst_cg_db_struct),
    ...
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<cst_cg_db_struct>())).model_shape as *const _ as usize },
        144usize,
        concat!(
            "Offset of field: ",
            stringify!(cst_cg_db_struct),
            "::",
            stringify!(model_shape)
        )
    );
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<cst_cg_db_struct>())).frame_advance as *const _ as usize },
        148usize,
        concat!(
            "Offset of field: ",
            stringify!(cst_cg_db_struct),
            "::",
            stringify!(frame_advance)
        )
    );
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<cst_cg_db_struct>())).num_dur_models as *const _ as usize },
        152usize,
        concat!(
            "Offset of field: ",
            stringify!(cst_cg_db_struct),
            "::",
            stringify!(num_dur_models)
        )
    );
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<cst_cg_db_struct>())).dur_stats as *const _ as usize },
        160usize,
        concat!(
            "Offset of field: ",
            stringify!(cst_cg_db_struct),
    ...
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<cst_cg_db_struct>())).dur_cart as *const _ as usize },
        168usize,
        concat!(
            "Offset of field: ",
            stringify!(cst_cg_db_struct),
    ...
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<cst_cg_db_struct>())).phone_states as *const _ as usize },
        176usize,
        concat!(
            "Offset of field: ",
            stringify!(cst_cg_db_struct),
            "::",
            stringify!(phone_states)
        )
    );
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<cst_cg_db_struct>())).do_mlpg as *const _ as usize },
        184usize,
        concat!(
            "Offset of field: ",
            stringify!(cst_cg_db_struct),
    ...
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<cst_cg_db_struct>())).dynwin as *const _ as usize },
        192usize,
        concat!(
            "Offset of field: ",
            stringify!(cst_cg_db_struct),
    ...
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<cst_cg_db_struct>())).dynwinsize as *const _ as usize },
        200usize,
        concat!(
            "Offset of field: ",
            stringify!(cst_cg_db_struct),
            "::",
            stringify!(dynwinsize)
        )
    );
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<cst_cg_db_struct>())).mlsa_alpha as *const _ as usize },
        204usize,
        concat!(
            "Offset of field: ",
            stringify!(cst_cg_db_struct),
            "::",
            stringify!(mlsa_alpha)
        )
    );
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<cst_cg_db_struct>())).mlsa_beta as *const _ as usize },
        208usize,
        concat!(
            "Offset of field: ",
            stringify!(cst_cg_db_struct),
    ...
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<cst_cg_db_struct>())).multimodel as *const _ as usize },
        212usize,
        concat!(
            "Offset of field: ",
            stringify!(cst_cg_db_struct),
            "::",
            stringify!(multimodel)
        )
    );
    assert_eq!(
        unsafe {
            &(*(::std::ptr::null::<cst_cg_db_struct>())).mixed_excitation as *const _ as usize
        },
        216usize,
        concat!(
            "Offset of field: ",
            stringify!(cst_cg_db_struct),
            "::",
            stringify!(mixed_excitation)
        )
    );
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<cst_cg_db_struct>())).ME_num as *const _ as usize },
        220usize,
        concat!(
            "Offset of field: ",
            stringify!(cst_cg_db_struct),
    ...
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<cst_cg_db_struct>())).ME_order as *const _ as usize },
        224usize,
        concat!(
            "Offset of field: ",
            stringify!(cst_cg_db_struct),
    ...
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<cst_cg_db_struct>())).me_h as *const _ as usize },
        232usize,
        concat!(
            "Offset of field: ",
            stringify!(cst_cg_db_struct),
    ...
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<cst_cg_db_struct>())).spamf0 as *const _ as usize },
        240usize,
        concat!(
            "Offset of field: ",
            stringify!(cst_cg_db_struct),
    ...
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<cst_cg_db_struct>())).gain as *const _ as usize },
        244usize,
        concat!(
            "Offset of field: ",
            stringify!(cst_cg_db_struct),
    ...
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<cst_cg_db_struct>())).phoneset as *const _ as usize },
        248usize,
        concat!(
            "Offset of field: ",
            stringify!(cst_cg_db_struct),
    ...
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<cst_cg_db_struct>())).char_sym_map as *const _ as usize },
        256usize,
        concat!(
            "Offset of field: ",
            stringify!(cst_cg_db_struct),
            "::",
            stringify!(char_sym_map)
        )
    );
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<cst_cg_db_struct>())).sym_phone_map as *const _ as usize },
        264usize,
        concat!(
            "Offset of field: ",
            stringify!(cst_cg_db_struct),
            "::",
            stringify!(sym_phone_map)
        )
    );
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<cst_cg_db_struct>())).freeable as *const _ as usize },
        272usize,
        concat!(
            "Offset of field: ",
            stringify!(cst_cg_db_struct),
...
pub type cst_cg_db = cst_cg_db_struct;
extern "C" {
    pub static cst_val_type_cg_db: ::std::os::raw::c_int;
}
extern "C" {
    pub fn val_cg_db(v: *const cst_val) -> *mut cst_cg_db;
}
extern "C" {
    pub fn cg_db_val(v: *const cst_cg_db) -> *mut cst_val;
}
extern "C" {
    pub fn delete_cg_db(db: *mut cst_cg_db);
}
extern "C" {
    pub fn cg_synth(utt: *mut cst_utterance) -> *mut cst_utterance;
}
extern "C" {
    pub fn mlsa_resynthesis(
        t: *const cst_track,
        str_: *const cst_track,
        cg_db: *mut cst_cg_db,
        asc: *mut cst_audio_streaming_info,
        mlsa_speech_param: ::std::os::raw::c_int,
    ) -> *mut cst_wave;
}
extern "C" {
    pub fn mlpg(param_track: *const cst_track, cg_db: *mut cst_cg_db) -> *mut cst_track;
}
extern "C" {
    pub fn cst_cg_load_voice(
        voxdir: *const ::std::os::raw::c_char,
        lang_table: *const cst_lang,
    ) -> *mut cst_voice;
}
extern "C" {
    pub fn cst_cg_dump_voice(
        v: *const cst_voice,
        filename: *const cst_string,
    ) -> ::std::os::raw::c_int;
}
extern "C" {
...
#[repr(C)]
#[derive(Debug, Copy, Clone)]
pub struct cst_vit_cand_struct {
    pub score: ::std::os::raw::c_int,
    pub val: *mut cst_val,
    pub ival: ::std::os::raw::c_int,
    pub pos: ::std::os::raw::c_int,
    pub item: *mut cst_item,
    pub next: *mut cst_vit_cand_struct,
}
#[test]
fn bindgen_test_layout_cst_vit_cand_struct() {
    assert_eq!(
        ::std::mem::size_of::<cst_vit_cand_struct>(),
        40usize,
        concat!("Size of: ", stringify!(cst_vit_cand_struct))
    );
    assert_eq!(
        ::std::mem::align_of::<cst_vit_cand_struct>(),
        8usize,
        concat!("Alignment of ", stringify!(cst_vit_cand_struct))
    );
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<cst_vit_cand_struct>())).score as *const _ as usize },
        0usize,
        concat!(
            "Offset of field: ",
            stringify!(cst_vit_cand_struct),
            "::",
            stringify!(score)
        )
    );
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<cst_vit_cand_struct>())).val as *const _ as usize },
        8usize,
        concat!(
            "Offset of field: ",
            stringify!(cst_vit_cand_struct),
    ...
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<cst_vit_cand_struct>())).ival as *const _ as usize },
        16usize,
        concat!(
            "Offset of field: ",
            stringify!(cst_vit_cand_struct),
    ...
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<cst_vit_cand_struct>())).pos as *const _ as usize },
        20usize,
        concat!(
            "Offset of field: ",
            stringify!(cst_vit_cand_struct),
    ...
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<cst_vit_cand_struct>())).item as *const _ as usize },
        24usize,
        concat!(
            "Offset of field: ",
            stringify!(cst_vit_cand_struct),
    ...
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<cst_vit_cand_struct>())).next as *const _ as usize },
        32usize,
        concat!(
            "Offset of field: ",
            stringify!(cst_vit_cand_struct),
...
pub type cst_vit_cand = cst_vit_cand_struct;
extern "C" {
    pub fn new_vit_cand() -> *mut cst_vit_cand;
}
extern "C" {
    pub fn vit_cand_set(vc: *mut cst_vit_cand, val: *mut cst_val);
}
extern "C" {
    pub fn vit_cand_set_int(vc: *mut cst_vit_cand, ival: ::std::os::raw::c_int);
}
extern "C" {
    pub fn delete_vit_cand(vc: *mut cst_vit_cand);
}
#[repr(C)]
#[derive(Debug, Copy, Clone)]
pub struct cst_vit_path_struct {
    pub score: ::std::os::raw::c_int,
    pub state: ::std::os::raw::c_int,
    pub cand: *mut cst_vit_cand,
    pub f: *mut cst_features,
    pub from: *mut cst_vit_path_struct,
    pub next: *mut cst_vit_path_struct,
}
#[test]
fn bindgen_test_layout_cst_vit_path_struct() {
    assert_eq!(
        ::std::mem::size_of::<cst_vit_path_struct>(),
        40usize,
        concat!("Size of: ", stringify!(cst_vit_path_struct))
    );
    assert_eq!(
        ::std::mem::align_of::<cst_vit_path_struct>(),
        8usize,
        concat!("Alignment of ", stringify!(cst_vit_path_struct))
    );
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<cst_vit_path_struct>())).score as *const _ as usize },
        0usize,
        concat!(
            "Offset of field: ",
            stringify!(cst_vit_path_struct),
            "::",
            stringify!(score)
        )
    );
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<cst_vit_path_struct>())).state as *const _ as usize },
        4usize,
        concat!(
            "Offset of field: ",
            stringify!(cst_vit_path_struct),
    ...
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<cst_vit_path_struct>())).cand as *const _ as usize },
        8usize,
        concat!(
            "Offset of field: ",
            stringify!(cst_vit_path_struct),
    ...
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<cst_vit_path_struct>())).f as *const _ as usize },
        16usize,
        concat!(
            "Offset of field: ",
            stringify!(cst_vit_path_struct),
    ...
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<cst_vit_path_struct>())).from as *const _ as usize },
        24usize,
        concat!(
            "Offset of field: ",
            stringify!(cst_vit_path_struct),
    ...
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<cst_vit_path_struct>())).next as *const _ as usize },
        32usize,
        concat!(
            "Offset of field: ",
            stringify!(cst_vit_path_struct),
...
pub type cst_vit_path = cst_vit_path_struct;
extern "C" {
    pub fn new_vit_path() -> *mut cst_vit_path;
}
extern "C" {
    pub fn delete_vit_path(vp: *mut cst_vit_path);
}
#[repr(C)]
#[derive(Debug, Copy, Clone)]
pub struct cst_vit_point_struct {
    pub item: *mut cst_item,
    pub num_states: ::std::os::raw::c_int,
    pub num_paths: ::std::os::raw::c_int,
    pub cands: *mut cst_vit_cand,
    pub paths: *mut cst_vit_path,
    pub state_paths: *mut *mut cst_vit_path,
    pub next: *mut cst_vit_point_struct,
}
#[test]
fn bindgen_test_layout_cst_vit_point_struct() {
    assert_eq!(
        ::std::mem::size_of::<cst_vit_point_struct>(),
        48usize,
        concat!("Size of: ", stringify!(cst_vit_point_struct))
    );
    assert_eq!(
        ::std::mem::align_of::<cst_vit_point_struct>(),
        8usize,
        concat!("Alignment of ", stringify!(cst_vit_point_struct))
    );
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<cst_vit_point_struct>())).item as *const _ as usize },
        0usize,
        concat!(
            "Offset of field: ",
            stringify!(cst_vit_point_struct),
            "::",
            stringify!(item)
        )
    );
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<cst_vit_point_struct>())).num_states as *const _ as usize },
        8usize,
        concat!(
            "Offset of field: ",
            stringify!(cst_vit_point_struct),
    ...
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<cst_vit_point_struct>())).num_paths as *const _ as usize },
        12usize,
        concat!(
            "Offset of field: ",
            stringify!(cst_vit_point_struct),
    ...
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<cst_vit_point_struct>())).cands as *const _ as usize },
        16usize,
        concat!(
            "Offset of field: ",
            stringify!(cst_vit_point_struct),
    ...
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<cst_vit_point_struct>())).paths as *const _ as usize },
        24usize,
        concat!(
            "Offset of field: ",
            stringify!(cst_vit_point_struct),
    ...
    assert_eq!(
        unsafe {
            &(*(::std::ptr::null::<cst_vit_point_struct>())).state_paths as *const _ as usize
        },
        32usize,
        concat!(
            "Offset of field: ",
            stringify!(cst_vit_point_struct),
            "::",
            stringify!(state_paths)
        )
    );
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<cst_vit_point_struct>())).next as *const _ as usize },
        40usize,
        concat!(
            "Offset of field: ",
            stringify!(cst_vit_point_struct),
...
pub type cst_vit_point = cst_vit_point_struct;
extern "C" {
    pub fn new_vit_point() -> *mut cst_vit_point;
}
extern "C" {
    pub fn delete_vit_point(vp: *mut cst_vit_point);
}
pub type cst_vit_cand_f_t = ::std::option::Option<
    unsafe extern "C" fn(s: *mut cst_item, vd: *mut cst_viterbi_struct) -> *mut cst_vit_cand,
>;
pub type cst_vit_path_f_t = ::std::option::Option<
    unsafe extern "C" fn(
        p: *mut cst_vit_path,
        c: *mut cst_vit_cand,
        vd: *mut cst_viterbi_struct,
    ) -> *mut cst_vit_path,
>;
#[repr(C)]
#[derive(Debug, Copy, Clone)]
pub struct cst_viterbi_struct {
    pub num_states: ::std::os::raw::c_int,
    pub cand_func: cst_vit_cand_f_t,
    pub path_func: cst_vit_path_f_t,
    pub big_is_good: ::std::os::raw::c_int,
    pub timeline: *mut cst_vit_point,
    pub last_point: *mut cst_vit_point,
    pub f: *mut cst_features,
}
#[test]
fn bindgen_test_layout_cst_viterbi_struct() {
    assert_eq!(
        ::std::mem::size_of::<cst_viterbi_struct>(),
        56usize,
        concat!("Size of: ", stringify!(cst_viterbi_struct))
    );
    assert_eq!(
        ::std::mem::align_of::<cst_viterbi_struct>(),
        8usize,
        concat!("Alignment of ", stringify!(cst_viterbi_struct))
    );
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<cst_viterbi_struct>())).num_states as *const _ as usize },
        0usize,
        concat!(
            "Offset of field: ",
            stringify!(cst_viterbi_struct),
            "::",
            stringify!(num_states)
        )
    );
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<cst_viterbi_struct>())).cand_func as *const _ as usize },
        8usize,
        concat!(
            "Offset of field: ",
            stringify!(cst_viterbi_struct),
    ...
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<cst_viterbi_struct>())).path_func as *const _ as usize },
        16usize,
        concat!(
            "Offset of field: ",
            stringify!(cst_viterbi_struct),
    ...
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<cst_viterbi_struct>())).big_is_good as *const _ as usize },
        24usize,
        concat!(
            "Offset of field: ",
            stringify!(cst_viterbi_struct),
            "::",
            stringify!(big_is_good)
        )
    );
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<cst_viterbi_struct>())).timeline as *const _ as usize },
        32usize,
        concat!(
            "Offset of field: ",
            stringify!(cst_viterbi_struct),
    ...
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<cst_viterbi_struct>())).last_point as *const _ as usize },
        40usize,
        concat!(
            "Offset of field: ",
            stringify!(cst_viterbi_struct),
    ...
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<cst_viterbi_struct>())).f as *const _ as usize },
        48usize,
        concat!(
            "Offset of field: ",
            stringify!(cst_viterbi_struct),
...
pub type cst_viterbi = cst_viterbi_struct;
extern "C" {
    pub fn new_viterbi(
        cand_func: cst_vit_cand_f_t,
        path_func: cst_vit_path_f_t,
    ) -> *mut cst_viterbi;
}
extern "C" {
    pub fn delete_viterbi(vd: *mut cst_viterbi);
}
extern "C" {
    pub fn viterbi_initialise(vd: *mut cst_viterbi, r: *mut cst_relation);
}
extern "C" {
    pub fn viterbi_decode(vd: *mut cst_viterbi);
}
extern "C" {
    pub fn viterbi_result(
        vd: *mut cst_viterbi,
        n: *const ::std::os::raw::c_char,
    ) -> ::std::os::raw::c_int;
}
extern "C" {
    pub fn viterbi_copy_feature(vd: *mut cst_viterbi, featname: *const ::std::os::raw::c_char);
}
#[repr(C)]
#[derive(Debug, Copy, Clone)]
pub struct cst_clunit_struct {
    pub type_: ::std::os::raw::c_ushort,
    pub phone: ::std::os::raw::c_ushort,
...
#[test]
fn bindgen_test_layout_cst_clunit_struct() {
    assert_eq!(
        ::std::mem::size_of::<cst_clunit_struct>(),
        20usize,
        concat!("Size of: ", stringify!(cst_clunit_struct))
    );
    assert_eq!(
        ::std::mem::align_of::<cst_clunit_struct>(),
        4usize,
        concat!("Alignment of ", stringify!(cst_clunit_struct))
    );
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<cst_clunit_struct>())).type_ as *const _ as usize },
        0usize,
        concat!(
            "Offset of field: ",
            stringify!(cst_clunit_struct),
            "::",
            stringify!(type_)
        )
    );
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<cst_clunit_struct>())).phone as *const _ as usize },
        2usize,
        concat!(
            "Offset of field: ",
            stringify!(cst_clunit_struct),
    ...
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<cst_clunit_struct>())).start as *const _ as usize },
        4usize,
        concat!(
            "Offset of field: ",
            stringify!(cst_clunit_struct),
    ...
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<cst_clunit_struct>())).end as *const _ as usize },
        8usize,
        concat!(
            "Offset of field: ",
            stringify!(cst_clunit_struct),
    ...
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<cst_clunit_struct>())).prev as *const _ as usize },
        12usize,
        concat!(
            "Offset of field: ",
            stringify!(cst_clunit_struct),
    ...
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<cst_clunit_struct>())).next as *const _ as usize },
        16usize,
        concat!(
            "Offset of field: ",
            stringify!(cst_clunit_struct),
...
pub type cst_clunit = cst_clunit_struct;
#[repr(C)]
#[derive(Debug, Copy, Clone)]
pub struct cst_clunit_type_struct {
    pub name: *const ::std::os::raw::c_char,
    pub start: ::std::os::raw::c_int,
    pub count: ::std::os::raw::c_int,
}
#[test]
fn bindgen_test_layout_cst_clunit_type_struct() {
    assert_eq!(
        ::std::mem::size_of::<cst_clunit_type_struct>(),
        16usize,
        concat!("Size of: ", stringify!(cst_clunit_type_struct))
    );
    assert_eq!(
        ::std::mem::align_of::<cst_clunit_type_struct>(),
        8usize,
        concat!("Alignment of ", stringify!(cst_clunit_type_struct))
    );
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<cst_clunit_type_struct>())).name as *const _ as usize },
        0usize,
        concat!(
            "Offset of field: ",
            stringify!(cst_clunit_type_struct),
            "::",
            stringify!(name)
        )
    );
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<cst_clunit_type_struct>())).start as *const _ as usize },
        8usize,
        concat!(
            "Offset of field: ",
            stringify!(cst_clunit_type_struct),
    ...
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<cst_clunit_type_struct>())).count as *const _ as usize },
        12usize,
        concat!(
            "Offset of field: ",
            stringify!(cst_clunit_type_struct),
...
pub type cst_clunit_type = cst_clunit_type_struct;
#[repr(C)]
#[derive(Debug, Copy, Clone)]
pub struct cst_clunit_db_struct {
    pub name: *const ::std::os::raw::c_char,
    pub types: *const cst_clunit_type,
    pub trees: *const *const cst_cart,
    pub units: *const cst_clunit,
    pub num_types: ::std::os::raw::c_int,
    pub num_units: ::std::os::raw::c_int,
    pub sts: *mut cst_sts_list,
    pub mcep: *mut cst_sts_list,
    pub join_weights: *const ::std::os::raw::c_int,
    pub optimal_coupling: ::std::os::raw::c_int,
    pub extend_selections: ::std::os::raw::c_int,
    pub f0_weight: ::std::os::raw::c_int,
    pub unit_name_func: ::std::option::Option<
        unsafe extern "C" fn(s: *mut cst_item) -> *mut ::std::os::raw::c_char,
    >,
}
#[test]
fn bindgen_test_layout_cst_clunit_db_struct() {
    assert_eq!(
        ::std::mem::size_of::<cst_clunit_db_struct>(),
        88usize,
        concat!("Size of: ", stringify!(cst_clunit_db_struct))
    );
    assert_eq!(
        ::std::mem::align_of::<cst_clunit_db_struct>(),
        8usize,
        concat!("Alignment of ", stringify!(cst_clunit_db_struct))
    );
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<cst_clunit_db_struct>())).name as *const _ as usize },
        0usize,
        concat!(
            "Offset of field: ",
            stringify!(cst_clunit_db_struct),
            "::",
            stringify!(name)
        )
    );
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<cst_clunit_db_struct>())).types as *const _ as usize },
        8usize,
        concat!(
            "Offset of field: ",
            stringify!(cst_clunit_db_struct),
    ...
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<cst_clunit_db_struct>())).trees as *const _ as usize },
        16usize,
        concat!(
            "Offset of field: ",
            stringify!(cst_clunit_db_struct),
    ...
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<cst_clunit_db_struct>())).units as *const _ as usize },
        24usize,
        concat!(
            "Offset of field: ",
            stringify!(cst_clunit_db_struct),
    ...
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<cst_clunit_db_struct>())).num_types as *const _ as usize },
        32usize,
        concat!(
            "Offset of field: ",
            stringify!(cst_clunit_db_struct),
    ...
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<cst_clunit_db_struct>())).num_units as *const _ as usize },
        36usize,
        concat!(
            "Offset of field: ",
            stringify!(cst_clunit_db_struct),
    ...
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<cst_clunit_db_struct>())).sts as *const _ as usize },
        40usize,
        concat!(
            "Offset of field: ",
            stringify!(cst_clunit_db_struct),
    ...
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<cst_clunit_db_struct>())).mcep as *const _ as usize },
        48usize,
        concat!(
            "Offset of field: ",
            stringify!(cst_clunit_db_struct),
    ...
    assert_eq!(
        unsafe {
            &(*(::std::ptr::null::<cst_clunit_db_struct>())).join_weights as *const _ as usize
        },
        56usize,
        concat!(
            "Offset of field: ",
            stringify!(cst_clunit_db_struct),
            "::",
            stringify!(join_weights)
        )
    );
    assert_eq!(
        unsafe {
            &(*(::std::ptr::null::<cst_clunit_db_struct>())).optimal_coupling as *const _ as usize
        },
        64usize,
        concat!(
            "Offset of field: ",
            stringify!(cst_clunit_db_struct),
            "::",
            stringify!(optimal_coupling)
        )
    );
    assert_eq!(
        unsafe {
            &(*(::std::ptr::null::<cst_clunit_db_struct>())).extend_selections as *const _ as usize
        },
        68usize,
        concat!(
            "Offset of field: ",
            stringify!(cst_clunit_db_struct),
            "::",
            stringify!(extend_selections)
        )
    );
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<cst_clunit_db_struct>())).f0_weight as *const _ as usize },
        72usize,
        concat!(
            "Offset of field: ",
            stringify!(cst_clunit_db_struct),
    ...
    assert_eq!(
        unsafe {
            &(*(::std::ptr::null::<cst_clunit_db_struct>())).unit_name_func as *const _ as usize
        },
        80usize,
        concat!(
            "Offset of field: ",
            stringify!(cst_clunit_db_struct),
            "::",
            stringify!(unit_name_func)
        )
    );
}
pub type cst_clunit_db = cst_clunit_db_struct;
extern "C" {
    pub static cst_val_type_clunit_db: ::std::os::raw::c_int;
}
extern "C" {
    pub fn val_clunit_db(v: *const cst_val) -> *mut cst_clunit_db;
}
extern "C" {
    pub fn clunit_db_val(v: *const cst_clunit_db) -> *mut cst_val;
}
extern "C" {
    pub static cst_val_type_vit_cand: ::std::os::raw::c_int;
}
extern "C" {
    pub fn val_vit_cand(v: *const cst_val) -> *mut cst_vit_cand;
}
extern "C" {
    pub fn vit_cand_val(v: *const cst_vit_cand) -> *mut cst_val;
}
extern "C" {
    pub fn clunits_synth(utt: *mut cst_utterance) -> *mut cst_utterance;
}
extern "C" {
    pub fn clunits_dump_units(utt: *mut cst_utterance) -> *mut cst_utterance;
}
extern "C" {
    pub fn clunits_ldom_phone_word(s: *mut cst_item) -> *mut ::std::os::raw::c_char;
}
extern "C" {
    pub fn clunit_get_unit_index(
        cludb: *mut cst_clunit_db,
        unit_type: *const ::std::os::raw::c_char,
        instance: ::std::os::raw::c_int,
    ) -> ::std::os::raw::c_int;
}
extern "C" {
    pub fn clunit_get_unit_index_name(
        cludb: *mut cst_clunit_db,
        name: *const ::std::os::raw::c_char,
    ) -> ::std::os::raw::c_int;
}
extern "C" {
    pub fn clunit_get_unit_type_index(
        cludb: *mut cst_clunit_db,
        name: *const ::std::os::raw::c_char,
    ) -> ::std::os::raw::c_int;
}
...
#[repr(C)]
#[derive(Debug, Copy, Clone)]
pub struct cst_ss_struct {
    pub num_samples: f64,
    pub sum: f64,
    pub sumx: f64,
}
#[test]
fn bindgen_test_layout_cst_ss_struct() {
    assert_eq!(
        ::std::mem::size_of::<cst_ss_struct>(),
        24usize,
        concat!("Size of: ", stringify!(cst_ss_struct))
    );
    assert_eq!(
        ::std::mem::align_of::<cst_ss_struct>(),
        8usize,
        concat!("Alignment of ", stringify!(cst_ss_struct))
    );
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<cst_ss_struct>())).num_samples as *const _ as usize },
        0usize,
        concat!(
            "Offset of field: ",
            stringify!(cst_ss_struct),
            "::",
            stringify!(num_samples)
        )
    );
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<cst_ss_struct>())).sum as *const _ as usize },
        8usize,
        concat!(
            "Offset of field: ",
            stringify!(cst_ss_struct),
    ...
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<cst_ss_struct>())).sumx as *const _ as usize },
        16usize,
        concat!(
            "Offset of field: ",
            stringify!(cst_ss_struct),
...
pub type cst_ss = cst_ss_struct;
extern "C" {
    pub fn new_ss() -> *mut cst_ss;
}
extern "C" {
    pub fn delete_ss(ss: *mut cst_ss);
}
extern "C" {
    pub fn ss_reset(ss: *mut cst_ss);
}
extern "C" {
    pub fn ss_mean(ss: *mut cst_ss) -> f64;
}
extern "C" {
    pub fn ss_variance(ss: *mut cst_ss) -> f64;
}
extern "C" {
    pub fn ss_stddev(ss: *mut cst_ss) -> f64;
}
extern "C" {
    pub fn ss_cummulate(ss: *mut cst_ss, a: f64);
}
extern "C" {
    pub fn ss_cummulate_n(ss: *mut cst_ss, a: f64, count: f64);
}
extern "C" {
    pub fn ph_vc(p: *const cst_item) -> *const cst_val;
}
extern "C" {
    pub fn ph_vlng(p: *const cst_item) -> *const cst_val;
}
extern "C" {
    pub fn ph_vheight(p: *const cst_item) -> *const cst_val;
}
extern "C" {
    pub fn ph_vrnd(p: *const cst_item) -> *const cst_val;
}
extern "C" {
    pub fn ph_vfront(p: *const cst_item) -> *const cst_val;
}
extern "C" {
    pub fn ph_ctype(p: *const cst_item) -> *const cst_val;
}
extern "C" {
    pub fn ph_cplace(p: *const cst_item) -> *const cst_val;
}
extern "C" {
    pub fn ph_cvox(p: *const cst_item) -> *const cst_val;
}
extern "C" {
    pub fn cg_duration(p: *const cst_item) -> *const cst_val;
}
extern "C" {
    pub fn cg_state_pos(p: *const cst_item) -> *const cst_val;
}
extern "C" {
    pub fn cg_state_place(p: *const cst_item) -> *const cst_val;
}
extern "C" {
    pub fn cg_state_index(p: *const cst_item) -> *const cst_val;
}
extern "C" {
    pub fn cg_state_rindex(p: *const cst_item) -> *const cst_val;
}
extern "C" {
    pub fn cg_phone_place(p: *const cst_item) -> *const cst_val;
}
extern "C" {
    pub fn cg_phone_index(p: *const cst_item) -> *const cst_val;
}
extern "C" {
    pub fn cg_phone_rindex(p: *const cst_item) -> *const cst_val;
}
extern "C" {
    pub fn basic_ff_register(ffunctions: *mut cst_features);
}
extern "C" {
    pub fn cst_socket_open(
        host: *const ::std::os::raw::c_char,
        port: ::std::os::raw::c_int,
    ) -> ::std::os::raw::c_int;
}
extern "C" {
    pub fn cst_socket_close(socket: ::std::os::raw::c_int) -> ::std::os::raw::c_int;
}
extern "C" {
    pub fn cst_socket_server(
        name: *const ::std::os::raw::c_char,
        port: ::std::os::raw::c_int,
        process_client: ::std::option::Option<
            unsafe extern "C" fn(
